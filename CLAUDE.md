...
```
النسخ المرقّمة القديمة (Index.html القديمة و2.0..0.html) محفوظة في تاريخ الريبو
قبل commit النقل الحالي. راجع git log على الريبو لالتقاط الـ sha بدقة وقت الحاجة.
git show <sha>:<file>.html
```
